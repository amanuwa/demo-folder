  ...
  Widget build(BuildContext context) {
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      // Container(
                      //   child: Text(
                      //     ('${specialvideos.length}\t\tof\t\t${specialnames.length}'),
    ...
    borderRadius: BorderRadius.only(
      ...
      topRight: Radius.circular(10.0),
                              ...
                              child: Center(child: Text(specialnames[index],style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold    ,fontSize: wdth*0.03),)),
                            ...
                            Container(
                               width: wdth*0.9,
                                ...
                                margin: const EdgeInsets.fromLTRB(10, 0, 0, 0),
                                 ...
                                 child:   VideoContainer(videoUrl: specialvideos[index])),
                                        Container(
                                                                    decoration: const BoxDecoration(
    color: Color.fromARGB(255, 12, 56, 92),
    borderRadius: BorderRadius.only(
      ...
      bottomRight: Radius.circular(10.0),
                              ...
                              child: Center(child: Text(specialprices[index],style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold    ,fontSize: wdth*0.03),)),
                  ...
                  Container(
                    child: (show)?Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                borderRadius: BorderRadius.only(
                                  ...
                                  child: Center(child: Text(subnames[index],style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold    ,fontSize: wdth*0.03),)),
                                ...
                                Container(
                                   width: wdth*0.9,
                                    ...
                                    margin: const EdgeInsets.fromLTRB(10, 0, 0, 0),
                                     ...
                                     child:   VideoContainer(videoUrl: subvideos[index])),
                                            Container(
                                                                        decoration: const BoxDecoration(
                                color: Color.fromARGB(255, 12, 56, 92),
                                borderRadius: BorderRadius.only(
                                  ...
                                  child: Center(child: Text(subprices[index],style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold    ,fontSize: wdth*0.03),)),
                      ...
                      child: Image.network('https://res.cloudinary.com/dxvzzdaln/image/upload/v1708002377/videos/image/advertise-your-business-here-300x232_unoioj.png'),
                      height: hight*0.5,
                      width: wdth,
                    )
                  ),
